...
import './AdminTestimonialCreate.css'
...
const AdminTestimonialCreate = () => {
    ...
    const [nameDemo, setNameDemo] = useState("Name goes here");
    const [descriptionDemo, setDescriptionDemo] = useState("Description goes here");
    ...
    const serviceFormHandler = (e) => {
        ...
        if (image === null) {
            ...
            axios.get('/sanctum/csrf-cookie')
                .then(response => {
                    axios.post(`/api/testimonial/create`, formData, config)
                        .then((response) => {
                    ...
                    <div className="card form__card" style={{ width: "100%" }}>
                        <form style={{ width: "100%" }} encType="multipart/form-data" onSubmit={serviceFormHandler}>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" id="title" placeholder="Enter Title" value={name} onChange={nameHandler} />
                            </div>
                            <div className="form-group">
